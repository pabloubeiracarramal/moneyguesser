...
export default function Landing() {
  ...
  const { setRoomCode, setToken, setIsHost, setDisplayName, setPlayerId } = useGame();
  ...
  const handleJoinRoom = async (e) => {
    ...
    try {
      const response = await joinRoom(joinCode.toUpperCase().trim(), username.trim());
  ...
  return (
    <div className="landing">
      <div className="landing-container">
        <h1 className="landing-title">💰 Money Guesser</h1>
        ...
        <div className="landing-form">
          ...
          <form onSubmit={handleJoinRoom} className="join-form">
            ...
            <button type="submit" className="btn btn-primary" disabled={loading || !username.trim() || !joinCode.trim()}>
